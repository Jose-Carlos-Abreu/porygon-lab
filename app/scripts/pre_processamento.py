...
def extrair_campos(pokemon_json, species_json):
    ...
    imagem = pokemon_json["sprites"]["other"]["official-artwork"]["front_default"]
...
def main():
    ...
    for pokemon_id in range(1, 20): # Teste inicial apenas com pokemons de Kanto
        ...
        download_imagem(pokemon_id, dados["imagem"])
